...
const sections = [
  ...
  { id: "uso", label: "4. Cómo usamos la información" },
  { id: "bases", label: "5. Bases para el tratamiento" },
  { id: "compartimos", label: "6. Cómo compartimos la información" },
  { id: "cookies", label: "7. Cookies" },
  { id: "retencion", label: "8. Retención" },
  { id: "derechos", label: "9. Derechos del titular" },
  { id: "seguridad", label: "10. Seguridad" },
  { id: "menores", label: "11. Datos de menores" },
  { id: "terceros", label: "12. Servicios de terceros" },
  { id: "transferencias", label: "13. Transferencias" },
  { id: "cambios", label: "14. Cambios" },
  { id: "contacto", label: "15. Contacto" },
  { id: "nota-final", label: "16. Nota final" },
];
...
const Privacidad = () => {
  return (
    <LegalPageLayout
      ...
      description="Conoce qué datos puede procesar MangoPOS, para qué los usa, cómo los protege y qué opciones tienen los usuarios y clientes respecto a su información."
      effectiveDate={legalMeta.privacyEffectiveDate}
      sectionLinks={sections}
      title="Política de Privacidad de MangoPOS"
      updatedAt={legalMeta.privacyUpdatedAt}
    >
